...
{
    // This script looks after the explosion after an obstacle has been hit.
    public class ObstacleExplosion : MonoBehaviour
    {
        public event Action<ObstacleExplosion> OnExplosionEnded;    // This event is triggered after the last particle system has finished.
