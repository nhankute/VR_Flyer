...
namespace VRStandardAssets.Flyer
{
    ...
    public class EnvironmentController : MonoBehaviour
    {
        ...
        public void StopEnvironment()
        {
            ...
            // While there are opponents in the collection, remove the first ring.
        ...
        private void HandleExplosionEnded(ObstacleExplosion explosion)
        {
        ...
        private void HandleOpponentHit(Opponent opponent)
        {
            ...
            // Subscribe to the asteroid explosion's event.
            obstacleExplosion.OnExplosionEnded += HandleExplosionEnded;
        }
    }
}